...
pub type Spi = avr_hal_generic::spi::Spi<crate::Atmega, crate::pac::SPI, port::PB1, port::PB2, port::PB3, port::PB0>;
#[cfg(any(
	feature = "atmega128a",
	feature = "atmega1280",
	feature = "atmega2560",
...
pub type Spi = avr_hal_generic::spi::Spi<crate::Atmega, crate::pac::SPI, port::PB5, port::PB3, port::PB4, port::PB2>;
#[cfg(any(
	feature = "atmega168",
	feature = "atmega328p",
	feature = "atmega48p",
...
pub type Spi0 = avr_hal_generic::spi::Spi<crate::Atmega, crate::pac::SPI0, port::PB5, port::PB3, port::PB4, port::PB2>;
#[cfg(feature = "atmega328pb")]
avr_hal_generic::impl_spi! {
    hal: crate::Atmega,
...
#[cfg(feature = "atmega328pb")]
pub type Spi1 = avr_hal_generic::spi::Spi<crate::Atmega, crate::pac::SPI1, port::PC1, port::PE3, port::PC0, port::PE2>;
#[cfg(feature = "atmega328pb")]
avr_hal_generic::impl_spi! {
    hal: crate::Atmega,
...
pub type Spi = avr_hal_generic::spi::Spi<crate::Atmega, crate::pac::SPI, port::PB7, port::PB5, port::PB6, port::PB4>;
#[cfg(any(feature = "atmega1284p", feature = "atmega32a"))]
avr_hal_generic::impl_spi! {
    hal: crate::Atmega,
    peripheral: crate::pac::SPI,
